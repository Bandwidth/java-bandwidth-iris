...
public class LnpOrderTest extends BaseModelTests {
    @Test
    public void testCreate() throws Exception {
        ...
        wirelessInfo.setAccountNumber("TestAcc");
        wirelessInfo.setPinNumber("123");
        lnpOrder.setWirelessInfo(wirelessInfo);
